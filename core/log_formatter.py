...
class EnhancedLogFormatter(logging.Formatter):
    ...
    def _get_ascii_prefix(self, logger_name: str, level_name: str) -> str:
        ...
        ascii_prefixes = {
            ...
            # Google Docs - both old location and new modular structure
            "gdocs.docs_tools": "[DOCS]",
            "gdocs.tools.document": "[DOCS]",
            "gdocs.tools.content": "[DOCS]",
            "gdocs.tools.formatting": "[DOCS]",
            "gdocs.tools.tables": "[DOCS]",
            "gdocs.tools.structure": "[DOCS]",
            "gdocs.tools.headers_footers": "[DOCS]",
            "gdocs.tools.named_ranges": "[DOCS]",
            "gdocs.tools.media": "[DOCS]",
            "gdocs.tools.tabs": "[DOCS]",
            "gdocs.tools.comments": "[DOCS]",
            # Google Sheets
            "gsheets.sheets_tools": "[SHEETS]",
            "gsheets.tools.spreadsheet": "[SHEETS]",
            "gsheets.tools.sheet": "[SHEETS]",
            "gsheets.tools.data": "[SHEETS]",
            "gsheets.tools.formatting": "[SHEETS]",
            "gsheets.tools.dimensions": "[SHEETS]",
            "gsheets.tools.manipulation": "[SHEETS]",
            "gsheets.tools.validation": "[SHEETS]",
            "gsheets.tools.named_ranges": "[SHEETS]",
            "gsheets.tools.protected_ranges": "[SHEETS]",
            "gsheets.tools.banding": "[SHEETS]",
            "gsheets.tools.comments": "[SHEETS]",
